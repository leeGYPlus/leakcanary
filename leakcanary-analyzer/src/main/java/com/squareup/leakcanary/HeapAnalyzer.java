 ...
 * 分析由 RefWatcher 生成的堆转储文件，检验是否检测的泄漏是否是真实的。
 */
public final class HeapAnalyzer {
   ...
   * 搜索的堆转储文件中{@link KeyedWeakReference}实例与相应的键,, 然后计算实例的强引用路径最短GC根。
   */
  public @NonNull AnalysisResult checkForLeak(@NonNull File heapDumpFile,
      @NonNull String referenceKey,
   ...
   * 修剪重复减少内存压力从hprof膨胀在棉花糖补充道;
   * 在版本中加入该功能：从膨胀的 hprof 中删除重复以减少内存压力。
   */
